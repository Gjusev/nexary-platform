    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-10 flex w-full flex-col items-center">
                ...
                {/* box outer circle */}
                <div className="absolute -bottom-8 z-30 grid h-[60px] w-[60px] place-items-center rounded-full border-t bg-background font-semibold text-xs">
                ...
                <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
                    ...
                    <div className="absolute bottom-8 left-12 z-10 h-7 rounded-full bg-background px-3 text-xs border flex items-center gap-2">
                        ...
                        <span>{buttonTexts?.first || "Nexary"}</span>
                    </div>
